...
Message::Message(const string& text, const string& sender, const string& receiver)
 : content(text), senderUsername(sender), receiverUsername(receiver), timestamp("")
{
    generateTimestamp();
}
...
const string& Message::getSenderUsername() const {
    return senderUsername; 
}

const string& Message::getReceiverUsername() const { 
